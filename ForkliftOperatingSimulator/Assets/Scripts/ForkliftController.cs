...
using UnityEngine;
    ...
    public class ForkliftController : MonoBehaviour
    {
        ...
        //[Range(0, 1)] [SerializeField]  // 0 is raw physics , 1 the car will grip in the direction it is facing
        //[Range(0, 1)] [SerializeField]  // 0 is no traction control, 1 is full interference
		...
		private float m_TractionControl = 1;
		private float m_SteerHelper = 1;
		...
		//Note: speed in kmp/h is equal to magnitude*3.6
        ...
        private void SteerHelper()
        {
			...
			//Helps avoid Gimbal Lock issue where car would go the wrong direction
        ...
        // this is used to add more grip scaling with speed
